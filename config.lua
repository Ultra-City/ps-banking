...
Config.TargetSystem = "DrawMarker" -- Change to your target script like ox_target, qb-target, Or use devyn's interact.
Config.drawmarkerType = 29
Config.drawmarkerDistance = 2.5
Config.Currency = {
    lang = "en", -- da-DK
    currency = "USD", -- DKK
}
